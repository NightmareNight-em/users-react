...
const NavBar = () => {
  ...
  const tippyContent = (
    <>
      {userData.length > 0 && userLeft.length > 0 && userRight.length > 0 ? (
        <>
          <div id="tippyCont">
            <div id="tippyProfile">
              <div>
            ...
            <div
              className="altUsers"
              onClick={() => {
                window.location = `/profile/${userLeft[0].username}`;
              }}
            >
              <div>
                <img src={userLeft[0].profilepicture} alt="pic" />
              </div>
              <div>{userLeft[0].name}</div>
            </div>
            <div
              className="altUsers"
              onClick={() => {
                window.location = `/profile/${userRight[0].username}`;
              }}
            >
              <div>
                <img src={userRight[0].profilepicture} alt="pic" />
              </div>
              <div>{userRight[0].name} </div>
            </div>
            <div id="logOutBtn">
        ...
        <>
          ...
          <nav id="navBar">
            ...
            >
              <div id="rightFlex">
                <div>
                  <img src={userData[0].profilepicture} alt="pic" />
                </div>
                <div>{userData[0].name}</div>
              </div>
            </Tippy>
